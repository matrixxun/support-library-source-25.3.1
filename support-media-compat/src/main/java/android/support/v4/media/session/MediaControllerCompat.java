...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        private class StubCompat implements IMediaControllerCallback {
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public MediaControllerImplApi21(Context context, MediaSessionCompat.Token sessionToken)
            ...
            if (mControllerObj == null) throw new Exception();
            requestExtraBinder();
        }
        ...
        private class ExtraCallback implements IMediaControllerCallback {
            ...
            @Override
            public void onEvent(final String event, final Bundle extras) throws Exception {
            ...
            @Override
            public void onSessionDestroyed() throws Exception {
                // Will not be called.
            ...
            @Override
            public void onMetadataChanged(MediaMetadataCompat metadata) throws Exception {
                // Will not be called.
                throw new AssertionError();
            }

            @Override
            public void onQueueChanged(List<QueueItem> queue) throws Exception {
                // Will not be called.
                throw new AssertionError();
            }

            @Override
            public void onQueueTitleChanged(CharSequence title) throws Exception {
                // Will not be called.
                throw new AssertionError();
            }

            @Override
            public void onRepeatModeChanged(final int repeatMode) throws Exception {
                mCallback.mHandler.post(new Runnable() {
                    @Override
                    public void run() {
            ...
            @Override
            public void onShuffleModeChanged(final boolean enabled) throws Exception {
                mCallback.mHandler.post(new Runnable() {
                    @Override
                    public void run() {
            ...
            @Override
            public void onExtrasChanged(Bundle extras) throws Exception {
                // Will not be called.
                throw new AssertionError();
            }

            @Override
            public void onVolumeInfoChanged(ParcelableVolumeInfo info) throws Exception {
                // Will not be called.
                throw new AssertionError();
            }
